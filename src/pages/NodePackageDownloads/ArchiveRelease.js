      ...
      <>
        <div className="stable-release-table">
          {props.showPaginationButton && (
            <div
              class="stable-release-arrow-container"
                  ...
                  <AccordionItem>
                    <AccordionButton className="stable-release-accordion-button">
                      ...
                      <div className="stable-release-table-row-item-release_note">
                        <a
                          href={`${
                            tabConfig.gitBaseUrls[_release.type]
                          }/releases/tag/${_release.tag_name}`}
                          target="_blank"
                        >
                          {_release.tag_name}
                        </a>
                      ...
                      <div className="stable-release-table-row-item-hardfork">
                        <a
                          href={
                            "https://docs.kaia.io/docs/misc/klaytn-history/#" +
                                ...
                                if (tagName === "v1.0.0") {
                                    ...
                                    if (
                                      ...
                                      return (
                                        <div className="stable-release-table-row">
                                          Only linux executable file is
                                          available. Packages are not supported.
                                        </div>
                                      );
                                    } else {
                                      return;
                                  ...
                                  if (tabConfig.machineType === "linux") {
                                    if (
                                      ...
                                      baseUrl =
                                        "https://packages.klaytn.net/baobab/kaia-v1.0.0/" +
                                        _binaryName +
                                        "-v1.0.0-linux-amd64";
                                      binaryFileformat =
                                        _binaryName + "-v1.0.0-linux-amd64";
                                    } else {
                                      return;
                                    }
                                  }
